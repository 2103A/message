...
type UserClient interface {
	...
	// 修改密码
	UserUpdatePassword(ctx context.Context, in *UserLoginRequest, opts ...grpc.CallOption) (*UserRegisterResponse, error)
}
...
func (c *userClient) UserUpdatePassword(ctx context.Context, in *UserLoginRequest, opts ...grpc.CallOption) (*UserRegisterResponse, error) {
	out := new(UserRegisterResponse)
...
type UserServer interface {
	...
	// 修改密码
	UserUpdatePassword(context.Context, *UserLoginRequest) (*UserRegisterResponse, error)
...
func (UnimplementedUserServer) UserUpdatePassword(context.Context, *UserLoginRequest) (*UserRegisterResponse, error) {
...
func _User_UserUpdatePassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).UserUpdatePassword(ctx, req.(*UserLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
